...
public class Client extends javax.swing.JFrame {
            ...
            public void run() {
                ...
                if (false) {
                    ...
                    try {
                        ...
                        System.out.println("Message to Server: " + MainText.getText());

                        //out.println("helloooo");
                        out.writeObject(MainText.getText().toString());
                        out.flush();
                        //                InputStream inClient = sock.getInputStream();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            int port = 8080;
            System.out.println("Waiting for connection! Port No " + port);
